...
public class UICamera : MonoBehaviour
{
	...
	static public void Notify (GameObject go, string funcName, object obj)
	{
		if (go != null)
		{
			...
			//hrli 2013-11-1 11:58:26
			E3DGameLib.Common.MessageSystem.isUIOperating = true;
			E3DGameLib.Common.MessageSystem.SendMsg(go.name + "_"+funcName,go,obj);
		}
	}
	...
	void Update ()
	{
		...
		//hrli 2013-11-2 8:38:56
		E3DGameLib.Common.MessageSystem.isUIOperating = false;
